...
*
      ...
      REAL*8 mass0(2),mass(2),massc(2),menv(2),mass00(2),mcxx(2), mzams0(2)
...
*
         m1ce = mass(j1)
         m2ce = mass(j2)
C          CALL comenv(mass0(j1),mass(j1),massc(j1),aj(j1),jspin(j1),
C      &               kstar(j1),mass0(j2),mass(j2),massc(j2),aj(j2),
C      &               jspin(j2),kstar(j2),zpars,ecc,sep,jorb,coel)
         CALL comenv(mass1i,mass0(j1),mass(j1),massc(j1),aj(j1),jspin(j1),
     &               kstar(j1),mass2i,mass0(j2),mass(j2),massc(j2),aj(j2),
...
C          CALL comenv(mass0(j2),mass(j2),massc(j2),aj(j2),jspin(j2),
C      &               kstar(j2),mass0(j1),mass(j1),massc(j1),aj(j1),
C      &               jspin(j1),kstar(j1),zpars,ecc,sep,jorb,coel)
         CALL comenv(mass2i,mass0(j2),mass(j2),massc(j2),aj(j2),jspin(j2),
     &               kstar(j2),mass1i,mass0(j1),mass(j1),massc(j1),aj(j1),
