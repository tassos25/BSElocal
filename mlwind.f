...
*	FOllowingHamman & Koesterke (1998)==1, following Nugis and Lamers(2000) ==2
	  ...
	  fLBV  = 7.d0
	  if (whichWR_wind.eq.1) fLBV  = 1.5d0
...
*
      mlwind = dms
*      write(*,*) mlwind, kw,lum,r,mt,mc,rl,z
