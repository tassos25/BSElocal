...
* using the STARTRACK prescription.
*
								...
								elseif(mc.lt.6.75d0)then
									mcx = 0.69d0*mc-2.26d0
								elseif(mc.ge.6.75d0)then
									mcx = 0.37d0*mc-0.07d0
								endif
								if(mc.lt.5.d0)then
									mfb = 0.d0
								elseif(mc.lt.7.6d0)then
									mfb = (0.378d0*mc-1.889d0)*(mt0-mcx)
								elseif(mc.ge.7.6)then
									mfb = mt0-mcx   
								endif
...
*
* Use NS/BH mass given by Fryer et. al. 2012, ApJ, 749, 91 to calculate initial mt
* using the Rapid supernova prescription.
*							
								mcx = 1.0d0
								if(mc.lt.2.50d0)then
									mfb = 0.2d0
								elseif(mc.lt.6.0d0)then
									mfb = 0.286d0*mc-0.514d0
