***
      SUBROUTINE COMENV(MZAMS1,M01,M1,MC1,AJ1,JSPIN1,KW1,
     &                  MZAMS2,M02,M2,MC2,AJ2,JSPIN2,KW2,
...
*
      REAL*8 MZAMS1, M01,M1,MC1,AJ1,JSPIN1,R1,L1,K21
      REAL*8 MZAMS2, M02,M2,MC2,AJ2,JSPIN2,R2,L2,K22,MC22
...
*     Set the CE flag to ++1, so that we know that the system went through one or more CE
      CE =CE + 1
...
C      LAMB1 = CELAMF(KW,M01,L1,R1,RZAMS,MENVD,LAMBDA)  
      LAMB1 = CELAMF(KW, MZAMS1, M1, MC1, R1, LAMBDA)
      KW = KW2
...
c         LAMB2 = CELAMF(KW,M02,L2,R2,RZAMS,MENVD,LAMBDA)
         LAMB2 = CELAMF(KW, MZAMS2, M2, MC2, R2, LAMBDA)
...
*      if (.not. COEL) write(*,*) COEL, LAMB1, KW, MZAMS1, M1, M02, MC1, R1
